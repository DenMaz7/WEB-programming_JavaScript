...
console.log("");
console.log("Важливо пам'ятати про правильну сумісність параметрів — якщо Ви задасте два кути, або прилеглий до катета кут і гіпотенузу, то програма не спрацює, оскільки в першому випадку відомі тільки кути, а цього не достатньо для розв'язання трикутника. В другому випадку «прилеглий до катета кут» так і 'кричить' про важливість наявності катета, як другого параметра. Хача було б круто, якби можна було розв'язати трикутник, маючи дві гіпотенузи :) \nАле так не працює, тому будьте уважні при передачі параметрів.");
